...
(function (global, factory) {
  ...
  (factory((global.Cordelia = {}),global.ng.core,global.ng.common));
  ...
  */
  ...
  var CordeliaComponent = /** @class */ (function () {
      ...
      CordeliaComponent.propDecorators = {
          el: [{ type: core.ViewChild, args: ['picker',] }],
          color: [{ type: core.Input }],
          colorFormat: [{ type: core.Input }],
          pickerStyle: [{ type: core.Input }],
          embed: [{ type: core.Input }],
          size: [{ type: core.Input }],
          allowOpacity: [{ type: core.Input }],
          allowClearColor: [{ type: core.Input }],
          showColorValue: [{ type: core.Input }],
          showButtons: [{ type: core.Input }],
          showPalette: [{ type: core.Input }],
          paletteColors: [{ type: core.Input }],
          allowPaletteAddColor: [{ type: core.Input }],
  ...
  exports.CordeliaComponent = CordeliaComponent;
  exports.CordeliaModule = CordeliaModule;
